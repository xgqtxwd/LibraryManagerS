...
import { bookListService, bookBorrowService, bookUpdateService, bookAddService, bookDeleteService } from "@/api/book.js";
  ...
  <el-card class="page-container">
    ...
    <el-table :data="articles" style="width: 100% " >
      ...
      <el-table-column label="操作" width="200">
        <template #default="{ row }">
          <el-button :icon="Edit" circle plain type="primary" @click="updateBookImg(row)"></el-button>
          <el-button type="success" plain @click="borrowBook(row)">借阅</el-button>
          <el-button type="danger" plain @click="deleteBook(row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
